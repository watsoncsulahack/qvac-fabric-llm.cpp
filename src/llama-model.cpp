...
bool llama_model::load_tensors(llama_model_loader & ml) {
    ...
    // create tensors for the weights
    {
        ...
        switch (arch) {
            ...
            case LLM_ARCH_QWEN35:
                // Qwen3.5 has a polymorphic loader that understands appended
                // NextN/MTP blocks. The legacy loader treated those blocks as
                // ordinary transformer layers and left their four nextn tensors
                // unclaimed (for example, "expected 335, got 331").
